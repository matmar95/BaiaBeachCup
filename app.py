...
# FIX BLOCCO CSS: Rimosso il parametro errato e sistemata la sintassi
st.markdown("""
    <style>
...
with tab2:
    ...
    # Embed dei gironi con range configurato per evitare spazi vuoti eccessivi
...
with tab3:
    ...
    # Embed del tabellone con il GID corretto (378239650)
...
with tab4:
    ...
    if not df_partite.empty:
        ...
        if col1 in df_partite.columns:
            ...
            if choice := scelta:
                filtro = df_partite[(df_partite[col1] == choice) | (df_partite[col2] == choice)]
